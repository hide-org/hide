...
func NewDockerDevContainer(id string, runner Runner) Container {
...
func (d *DockerDevContainer) Ssh(ctx context.Context, command []string, opts ...SshOption) (string, error) {
	return "", nil
}

type Service interface {
	Create(ctx context.Context, gitURL string) (Container, error)
...
func (s *DockerService) Create(ctx context.Context, gitURL string, commit *string, config *Config) (Container, error) {
...
func (c *DaytonaContainer) Ssh(ctx context.Context, command []string, opts ...SshOption) (string, error) {
	return "", nil
}

func NewDaytonaContainer(workspace *daytona.Workspace, daytona *daytona.APIClient) Container {
...
func (s *DaytonaService) Create(ctx context.Context, gitURL string) (Container, error) {
...
func (s *DaytonaService) Get(ctx context.Context, containerId string) (Container, error) {
	return nil, nil
}
